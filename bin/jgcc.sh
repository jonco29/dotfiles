...
if [ "$AOSP_ROOT" == "" ]; then
    echo you need to set AOSP to the top of your AOSP directory
    exit 1
    ## what i have set
    ## AOSP_ROOT=/home/jc/space/work/android/aosp_panda2
else
    echo using: AOSP_ROOT: $AOSP_ROOT
    AGCC_NDK=${AOSP_ROOT}/prebuilt/ndk/android-ndk-r8
...
TOOLCHAIN=${AOSP_ROOT}/prebuilt/linux-x86/toolchain/arm-linux-androideabi-4.4.x
PREBUILT=$TOOLCHAIN
